...
const SignupHeader = () => {
  ...
  return (
    // MAIN CONTAINER
    <div className='flex items-center lg:flex-row lg:items-center justify-between px-1 lg:px-2 h-18 w-full lg:h-28 bg-[#fce2c5]'>
      {/* WAPDA LOGO + TEXT */}
      <div className="flex items-center gap-2 lg:mt-0 lg:gap-4">
        <img className='h-14 w-14 lg:h-26 lg:w-28 bg-white rounded-2xl' src={WapdaLOGO} alt="WapdaLogo" />

        {/* TEXT SECTION */}
        <div className='lg:mx-2'>
          <p className='hidden lg:block text-sm font-bold lg:text-2xl text-blue-900'>
          ...
          <p className='hidden lg:block text-xs font-bold lg:text-lg text-blue-900'>
